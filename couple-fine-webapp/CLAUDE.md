...
2. **자동 로그아웃 문제 해결** (2025-08-08)
   - 네트워크가 느릴 때 자동 로그아웃되는 문제 수정
   - 타임아웃을 5초에서 30초로 증가
   - 10분마다 세션 자동 갱신 메커니즘 추가
   - 네트워크 오류와 실제 로그아웃 구분
...
*최종 업데이트: 2025-08-08 21:00 (커플 연결 축하 플로우 개선 - 양쪽 모두 축하 페이지 보기)*